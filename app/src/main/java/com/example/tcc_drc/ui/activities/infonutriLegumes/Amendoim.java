        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                try {
                    ...
                    stmt.bindString(1, "Informação Nutricional: Amendoim");
                    stmt.executeInsert();

                    stmt.bindString(1, "Porção: 1 colher de sopa 15g ");
                    stmt.executeInsert();

                    stmt.bindString(1, "Valor energético (Kcal): 90,9");
                    stmt.executeInsert();

                    stmt.bindString(1, "Carboidratos (g): 2,8");
                    stmt.executeInsert();

                    stmt.bindString(1, "Açúcares (g): 0,6");
                    stmt.executeInsert();

                    stmt.bindString(1, "Proteínas (g): 3,4");
                    stmt.executeInsert();
                    ...
                    stmt.bindString(1, "Sódio (mg): 56,4");
                    stmt.executeInsert();

                    stmt.bindString(1, "Fósforo (mg): 39,1");
                    stmt.executeInsert();

                    stmt.bindString(1, "Potássio (mg); 74,3");
                    stmt.executeInsert();
                    bancoDados.close();
                    listarDados();
